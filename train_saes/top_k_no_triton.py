...
class AutoEncoderTopK(Dictionary, nn.Module):
    ...
    # The following is the implementation using Triton kernels

    # Problem: There is an intermediate topk between encode and decode
    # This breaks the abstraction of the dictionary class, causing problems with
    # evaluation and attribution patching
    ...
    # NOTE: We also have to make some modifications in training code to handle this
    ...
    def decode(self, x: t.Tensor) -> t.Tensor:
        return (x @ self.decoder) + self.b_dec
...
class TrainerTopK(SAETrainer):
    ...
    def __init__(
        ...
        self.dead_feature_threshold = 10  # TODO _000_000
